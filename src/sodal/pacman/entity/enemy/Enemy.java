...
public class Enemy extends Entity {
    ...
    public Enemy(int x, int y, int width, int height, int speed) {
        ...
        rect[2] = new Rectangle(this.x + 3, this.y + 4, this.width-7, 2);
        rect[3] = new Rectangle(this.x + 5, this.y + 2, this.width-10, 2);
    }
    ...
    public void render(Graphics2D g2) {
       ...
       g2.fillRect(this.rect[1].x, this.rect[1].y, this.rect[1].width, this.rect[1].height);
        ...
        g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, alpha));
        g2.setColor(new Color(25, 20, 250, (int)(255 * alpha))); // Blue with transparency
        g2.fillRect(this.rect[2].x, this.rect[2].y, this.rect[2].width, this.rect[2].height);


        g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC_OVER, alpha));
        g2.setColor(new Color(250, 20, 250, (int)(255 * alpha))); // Blue with transparency
